      ...
      <div class='container pt-md-2' id='reviews'>
        <div class='row pb-3'>
          <div class='col-lg-4 col-md-5'>
            <h2 class='h3 mb-4'>376 Avaliações</h2>
            <div class='star-rating mr-2'>
						...
						<span class='d-inline-block align-middle'>4.7 Avaliação Geral</span>
            <p class='pt-3 font-size-sm text-muted'>341 de 376 (90%)<br>mamães recomendam nossos produtos</p>
          </div>
          <div class='col-lg-8 col-md-7'>
            <div class='d-flex align-items-center mb-2'>
              <div class='text-nowrap mr-3'><span class='d-inline-block align-middle text-muted'>5</span><i class='fas fa-star font-size-xs ml-1'></i></div>
              <div class='w-100'>
                <div class='progress' style='height: 4px;'>
                  <div class='progress-bar bg-success' role='progressbar' style='width: 58%;' aria-valuenow='60' aria-valuemin='0' aria-valuemax='100'></div>
                </div>
              </div><span class='text-muted ml-3'>219</span>
            </div>
            <div class='d-flex align-items-center mb-2'>
              <div class='text-nowrap mr-3'><span class='d-inline-block align-middle text-muted'>4</span><i class='fas fa-star font-size-xs ml-1'></i></div>
              <div class='w-100'>
                <div class='progress' style='height: 4px;'>
                  <div class='progress-bar' role='progressbar' style='width: 25%; background-color: #a7e453;' aria-valuenow='27' aria-valuemin='0' aria-valuemax='100'></div>
                </div>
              </div><span class='text-muted ml-3'>95</span>
            </div>
            <div class='d-flex align-items-center mb-2'>
              <div class='text-nowrap mr-3'><span class='d-inline-block align-middle text-muted'>3</span><i class='fas fa-star font-size-xs ml-1'></i></div>
              <div class='w-100'>
                <div class='progress' style='height: 4px;'>
                  <div class='progress-bar' role='progressbar' style='width: 8%; background-color: #ffda75;' aria-valuenow='17' aria-valuemin='0' aria-valuemax='100'></div>
                </div>
              </div><span class='text-muted ml-3'>32</span>
            </div>
            <div class='d-flex align-items-center mb-2'>
              <div class='text-nowrap mr-3'><span class='d-inline-block align-middle text-muted'>2</span><i class='fas fa-star font-size-xs ml-1'></i></div>
              <div class='w-100'>
                <div class='progress' style='height: 4px;'>
                  <div class='progress-bar' role='progressbar' style='width: 4%; background-color: #fea569;' aria-valuenow='9' aria-valuemin='0' aria-valuemax='100'></div>
                </div>
              </div><span class='text-muted ml-3'>18</span>
            </div>
            <div class='d-flex align-items-center'>
              <div class='text-nowrap mr-3'><span class='d-inline-block align-middle text-muted'>1</span><i class='fas fa-star font-size-xs ml-1'></i></div>
              <div class='w-100'>
                <div class='progress' style='height: 4px;'>
                  <div class='progress-bar bg-danger' role='progressbar' style='width: 3%;' aria-valuenow='4' aria-valuemin='0' aria-valuemax='100'></div>
                </div>
          ...
          <div class='col-md-7'>
					 <div class='d-flex justify-content-end pb-4'>
						<div class='form-inline flex-nowrap'>
							<label class='text-muted text-nowrap mr-2 d-none d-sm-block' for='sort-reviews'>Ordenado por:</label>
							<select class='custom-select custom-select-sm' id='sort-reviews' readonly>
            ...
            <div class='product-review pb-4 mb-4 border-bottom'>
              <div class='d-flex mb-3'>
                <div class='media align-items-center mr-4 pr-2'><img class='rounded-circle' width='50' src='img/shop/reviews/01.jpg' alt='Rafael Marquez'/>
            ...
            <div class='product-review pb-4 mb-4 border-bottom'>
              <div class='d-flex mb-3'>
                <div class='media align-items-center mr-4 pr-2'><img class='rounded-circle' width='50' src='img/shop/reviews/02.jpg' alt='Barbara Palson'/>
                  <div class='media-body pl-3'>
            ...
            <div class='product-review pb-4 mb-4 border-bottom'>
              <div class='d-flex mb-3'>
                <div class='media align-items-center mr-4 pr-2'><img class='rounded-circle' width='50' src='img/shop/reviews/03.jpg' alt='Daniel Adams'/>
                  <div class='media-body pl-3'>
              ...
              <div class='text-nowrap'>
                <button class='btn-like' type='button'>19</button>
