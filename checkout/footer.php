	...
	<footer class='bg-dark pt-5'>
      ...
      <div class='pt-5 bg-darker'>
        <div class='container'>
          ...
          <div class='pb-4 font-size-xs text-light opacity-50 text-center'>BABADROOM© 2019. Todos os direitos reservados.<br>
						Plataforma criada por <a class='text-light' href='https://imperialize.me/' target='_blank'>IMPERIALIZE Tecnologia</a>
					</div>
