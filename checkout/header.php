                ...
                <li class='nav-item dropdown'><a class='nav-link dropdown-toggle' href='#' data-toggle='dropdown'>Navegar</a>
                  <div class='dropdown-menu p-0'>
                    <div class='d-flex flex-wrap flex-md-nowrap px-2'>
                      ...
                      <div class='py-4 pr-3' style='width: 15rem;' data-toggle='tooltip' data-placement='left' title='Lindo Produto em Liquidação. Clique para ver detalhes...'>
												<a class='d-block' href='i.php?p=010203'><img src='../img/shop/promo-menu.jpg' alt='Promo banner'/></a>
											</div>
								...
								<li class='nav-item dropdown'>
									<a class='nav-link dropdown-toggle' href='WhatsApp' data-toggle='dropdown'>Atendimento</a>
